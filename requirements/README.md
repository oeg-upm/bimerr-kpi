...
<table style="width:100%; border: 1px solid">
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The purpose of this model is to represent key performance indicators related to building renovation projects.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The scope of this ontology is limited to the KPI data shared through the BIF.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>Exchange of data about KPI's and renovation measures</td>
  </tr>
